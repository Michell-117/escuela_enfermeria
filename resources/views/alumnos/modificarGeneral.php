...
<head>
    ...
    <title>Modificar alumnoGeneral</title>
</head>
<body>

    <h1>Modificar alumno general</h1>

    <!-- Formulario para modificar el nombre del alumno -->
    <form action="" method="post">

        <label for="cuenta_alumno_general">Cuenta Alumno</label>
        <select name="cuenta_alumno_general" id="cuenta_alumno_general" required>
            <?php foreach($resultadosalumnoGeneralCuenta as $cuenta):?>
                <option value="<?=$cuenta["cuenta"]?>"><?=$cuenta["cuenta"]?></option>
            <?php endforeach; ?>
            
        </select>

        <label for="nombre">Modificar Nombre Alumno</label>
        <input type="text" name="nombre" id="nombre" placeholder="Nombre">


        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_nombre">
    ...
    <!-- Formulario para modificar el nombre_2 del alumno -->
    <form action="" method="post">
        ...
        <label for="nombre_2">Modificar Segundo Nombre Alumno</label>
        <input type="text" name="nombre_2" id="nombre_2" placeholder="Segundo nombre">


        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_nombre_2">
    ...
    <!-- Formulario para modificar el apellido_paterno del alumno -->
    <form action="" method="post">
        ...
        <label for="apellido_paterno">Modificar Apellido Paterno Alumno</label>
        <input type="text" name="apellido_paterno" id="apellido_paterno" placeholder="Apellido paterno">


        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_apellido_paterno">
    ...
    <!-- Formulario para modificar el apellido_materno del alumno -->
    <form action="" method="post">
        ...
        <label for="apellido_materno">Modificar Apellido Materno Alumno</label>
        <input type="text" name="apellido_materno" id="apellido_materno" placeholder="Apellido materno">


        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_apellido_materno">
    ...
    <!-- Formulario para modificar el genero del alumno -->
    <form action="" method="post">
        ...
        <label for="genero">Modificar Género</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_genero">
    ...
    <!-- Formulario para modificar el curp del alumno -->
    <form action="" method="post">
        ...
        <label for="curp">Modificar CURP Alumno</label>
        <input type="text" name="curp" id="curp" placeholder="CURP">

        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_curp">
    ...
    <!-- Formulario para modificar el fecha_nacimiento del alumno -->
    <form action="" method="post">
        ...
        <label for="fecha_nacimiento">Modificar Fecha de nacimiento</label>
        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento">

        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_fecha_nacimiento">
    ...
    <!-- Formulario para modificar el edad del alumno -->
    <form action="" method="post">
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_edad">
    ...
    <!-- Formulario para modificar el nivel_maximo_estudios del alumno -->
    <form action="" method="post">
        ...
        <label for="nivel_maximo_estudios">Modificar Nivel Máximo de Estudios</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_nivel_maximo_estudios">
    ...
    <!-- Formulario para modificar el entidad_federativa del alumno -->
    <form action="" method="post">
        ...
        <label for="entidad_federativa">Modificar Entidad Federativa</label>
        <select name="entidad_federativa" id="entidad_federativa">
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_entidad_federativa">
    ...
    <!-- Formulario para modificar el grupo_indigena del alumno -->
    <form action="" method="post">
        ...
        <label for="grupo_indigena">Modificar Grupo Indigena</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_grupo_indigena">
    ...
    <!-- Formulario para modificar el lengua_indigena del alumno -->
    <form action="" method="post">
        ...
        <label for="lengua_indigena">Modificar Lengua Indigena</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_lengua_indigena">
    ...
    <!-- Formulario para modificar el ciclo_escolar del alumno -->
    <form action="" method="post">
        ...
        <label for="ciclo_escolar">Modificar Ciclo escolar</label>
        <input type="text" name="ciclo_escolar" id="ciclo_escolar" placeholder="2024-2">

        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_ciclo_escolar">
    ...
    <!-- Formulario para modificar el estatus del alumno -->
    <form action="" method="post">
        ...
        <label for="estatus">Modificar Estatus</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_estatus">
    ...
    <!-- Formulario para modificar el plantel_grupo_id del alumno -->
    <form action="" method="post">
        ...
        <label for="plantel_grupo_id">Modificar Grupo</label>
        <select name="plantel_grupo_id" id="plantel_grupo_id" required>
            <?php foreach($resultados_grupos_plantel as $grupo_escolar):?>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_plantel_grupo_id">
    ...
    <!-- Formulario para modificar el plantel del alumno -->
    <form action="" method="post">

        <label for="cuenta_alumno_general">Plantel Alumno</label>
        <select name="cuenta_alumno_general" id="cuenta_alumno_general" required>
            <?php foreach($resultadosalumnoGeneralCuenta as $cuenta):?>
                <option value="<?=$cuenta["cuenta"]?>"><?=$cuenta["cuenta"]?></option>
            <?php endforeach; ?>
        ...
        <label for="id_plantel">Modificar plantel</label>
        ...
        <input type="hidden" name="method" value="post">
        <input type="hidden" name="formulario" value="modificar_alumno_general_plantel">
